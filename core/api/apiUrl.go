...
func ReturnURLS() *urls {
	...
	apiurls.AGGREGATOR_PATH_READ = apiurls.AGGREGATOR_PATH + "/read/{id:[0-9]+}"
	apiurls.AGGREGATOR_PATH_UPDATE = apiurls.AGGREGATOR_PATH + "/update/{id:[0-9]+}"
	apiurls.AGGREGATOR_PATH_DELETE = apiurls.AGGREGATOR_PATH + "/delete/{id:[0-9]+}"
	...
	apiurls.CLUSTER_PATH_UPDATE = apiurls.CLUSTER_PATH + "/update/{id:[0-9]+}"
	apiurls.CLUSTER_PATH_DELETE = apiurls.CLUSTER_PATH + "/delete/{id:[0-9]+}"
	...
	apiurls.CONNECTOR_PATH_READ = apiurls.CONNECTOR_PATH + "/read/{id:[0-9]+}"
	apiurls.CONNECTOR_PATH_UPDATE = apiurls.CONNECTOR_PATH + "/update/{id:[0-9]+}"
	apiurls.CONNECTOR_PATH_DELETE = apiurls.CONNECTOR_PATH + "/delete/{id:[0-9]+}"
	apiurls.ROLE_PATH = "/role"
	apiurls.ROLE_PATH_LIST = apiurls.ROLE_PATH + "/list"
	apiurls.ROLE_PATH_CREATE = apiurls.ROLE_PATH + "/create"
	apiurls.ROLE_PATH_READ = apiurls.ROLE_PATH + "/read/{id:[0-9]+}"
	apiurls.ROLE_PATH_UPDATE = apiurls.ROLE_PATH + "/update/{id:[0-9]+}"
	apiurls.ROLE_PATH_DELETE = apiurls.ROLE_PATH + "/delete/{id:[0-9]+}"
	apiurls.USER_PATH = "/user"
	apiurls.USER_PATH_LIST = apiurls.USER_PATH + "/list"
	apiurls.USER_PATH_CREATE = apiurls.USER_PATH + "/create"
	apiurls.USER_PATH_READ = apiurls.USER_PATH + "/read/{id:[0-9]+}"
	apiurls.USER_PATH_UPDATE = apiurls.USER_PATH + "/update/{id:[0-9]+}"
	apiurls.USER_PATH_DELETE = apiurls.USER_PATH + "/delete/{id:[0-9]+}"
	...
	apiurls.TENANT_PATH_READ = apiurls.TENANT_PATH + "/read/{id:[0-9]+}"
	apiurls.TENANT_PATH_UPDATE = apiurls.TENANT_PATH + "/update/{id:[0-9]+}"
	apiurls.TENANT_PATH_DELETE = apiurls.TENANT_PATH + "/delete/{id:[0-9]+}"
