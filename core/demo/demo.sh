...
./gandalf -g connector -l Connector1 -t tenant1 -b 127.0.0.1:7000 -r 127.0.0.1:7010 -a 127.0.0.1:8000 -y Utils -v 1,2 -w $HOME/gandalf/workers
./gandalf -g connector -l Connector2 -t tenant1 -b 127.0.0.1:7100 -r 127.0.0.1:7110 -a 127.0.0.1:8100 -y Workflow -v 1 -w $HOME/gandalf/workers -z https://github.com/ditrit/gandalf_workers/raw/master/Workflow.zip
