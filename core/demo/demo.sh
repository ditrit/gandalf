...
./gandalf -g connector -l Connector1 -t tenant1 -b 127.0.0.1:7000 -r 127.0.0.1:7010 -a 127.0.0.1:8000 -y Utils -p Custom -v 1,2 -w $HOME/gandalf/workers -z https://github.com/ditrit/gandalf-workers/raw/master
./gandalf -g connector -l Connector2 -t tenant1 -b 127.0.0.1:7100 -r 127.0.0.1:7110 -a 127.0.0.1:8100 -y Workflow -p Custom -v 1 -w $HOME/gandalf/workers -z https://github.com/ditrit/gandalf-workers/raw/master
./gandalf -g connector -l Connector3 -t tenant1 -b 127.0.0.1:7200 -r 127.0.0.1:7210 -a 127.0.0.1:8200 -y Azure
./gandalf -g connector -l Connector4 -t tenant1 -b 127.0.0.1:7300 -r 127.0.0.1:7310 -a 127.0.0.1:8300 -y VersionControlSystems -p Gitlab -v 1 -w $HOME/gandalf/workers -z https://github.com/ditrit/gandalf-workers/raw/master
sleep 5
