...
./gandalf -g connector -l Connector1 -i Connector1 -t tenant1 -b 127.0.0.1:7000 -r 127.0.0.1:7010 -a 127.0.0.1:8000 -y Utils -p Custom -v 1.0,2.2 -w $HOME/gandalf/workers -z https://github.com/ditrit/gandalf-workers/raw/master -s TOTO
./gandalf -g connector -l Connector2 -i Connector2 -t tenant1 -b 127.0.0.1:7100 -r 127.0.0.1:7110 -a 127.0.0.1:8100 -y Workflow -p Custom -v 1.0 -w $HOME/gandalf/workers -z https://github.com/ditrit/gandalf-workers/raw/master -s TOTO
