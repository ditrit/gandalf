...
func CreateEnvironment(w http.ResponseWriter, r *http.Request) {
	...
	if database != nil {
		...
		if err := dao.CreateEnvironment(database, environment); err != nil {
			utils.RespondWithError(w, http.StatusInternalServerError, err.Error())
			return
		}

		utils.RespondWithJSON(w, http.StatusCreated, environment)
	} else {
...
func DeleteEnvironment(w http.ResponseWriter, r *http.Request) {
	...
	database := utils.DatabaseConnection.GetTenantDatabaseClient()
	if database != nil {
		id, err := strconv.Atoi(vars["environmentId"])
		if err != nil {
			utils.RespondWithError(w, http.StatusBadRequest, "Invalid Product ID")
			return
		}

		if err := dao.DeleteEnvironment(database, id); err != nil {
			utils.RespondWithError(w, http.StatusInternalServerError, err.Error())
			return
		}
...
func GetEnvironmentById(w http.ResponseWriter, r *http.Request) {
	...
	if database != nil {
		...
		var environment models.Environment
		if environment, err = dao.ReadEnvironment(database, id); err != nil {
			switch err {
			case sql.ErrNoRows:
		...
		utils.RespondWithJSON(w, http.StatusOK, environment)
	} else {
		utils.RespondWithError(w, http.StatusInternalServerError, "tenant not found")
		return
	}
...
func ListEnvironment(w http.ResponseWriter, r *http.Request) {
	...
	database := utils.DatabaseConnection.GetTenantDatabaseClient()
	if database != nil {
		environments, err := dao.ListEnvironment(database)
		if err != nil {
			utils.RespondWithError(w, http.StatusInternalServerError, err.Error())
			return
		}
...
func UpdateEnvironment(w http.ResponseWriter, r *http.Request) {
	...
	if database != nil {
		...
		if err := dao.UpdateEnvironment(database, environment); err != nil {
			utils.RespondWithError(w, http.StatusInternalServerError, err.Error())
			return
		}
