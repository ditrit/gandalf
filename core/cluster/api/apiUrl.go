...
func ReturnURLS() *Urls {
	...
	apiurls.TENANTS_CONNECTOR_PATH_DECLARE_MEMBER = apiurls.TENANTS_CONNECTOR_PATH + "/declare/"
	...
	apiurls.TENANTS_AGGREGATOR_PATH_DECLARE_MEMBER = apiurls.TENANTS_AGGREGATOR_PATH + "/declare/"
