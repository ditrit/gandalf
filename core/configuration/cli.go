...
var cliList = config.NewConfigCmd("list", "list users|tenants|roles|dom²ains", "list command allows to list Gandalf objects (users, tenants, roles and domains).", nil)
...
func init() {
	...
	cliCfg.Key("endpoint", config.IsStr, "t", "Gandalf auth token")
