...
func InitClusterKeys() {
	...
	_ = SetStringKeyConfig("cluster", "db_path", "", homePath+"/gandalf/database", "path for the gandalf database", true)
	_ = SetStringKeyConfig("cluster", "db_name", "", "node1", "path for the gandalf database", true)
}
