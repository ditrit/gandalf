...
import (
	...
	"gandalf/libraries/goclient/models"
...
type Worker struct {
	...
	CommandesFuncs  map[string]func(clientGandalf *goclient.ClientGandalf, major, minor int64) int
	EventsFuncs     map[string]func(clientGandalf *goclient.ClientGandalf, major, minor int64) int
...
func (w Worker) waitCommands(id, commandName string, function func(clientGandalf *goclient.ClientGandalf, major, minor int64) int) {
...
func (w Worker) executeCommands(command msg.Command, function func(clientGandalf *goclient.ClientGandalf, major, minor int64) int) {
...
//TODO REVOIR
func (w Worker) WaitEvents(id, eventName string, function func(clientGandalf *goclient.ClientGandalf, major, minor int64) int) {
...
//TODO REVOIR
func (w Worker) ExecuteEvents(event msg.Event, function func(clientGandalf *goclient.ClientGandalf, major, minor int64) int) {
	/* 	result := function(w.clientGandalf, w.major, w.minor)
	   	if result == 0 {
	   		//w.clientGandalf.SendReply(command.GetCommand(), "SUCCES", command.GetUUID(), models.NewOptions("", ""))
	   	} else {
