...
func NewAggregatorGandalf(path string) (aggregatorGandalf *AggregatorGandalf) {
	...
	aggregatorGandalf.aggregatorCommandRoutine = NewAggregatorCommandRoutine(aggregatorGandalf.aggregatorConfiguration.Identity, aggregatorGandalf.aggregatorConfiguration.Tenant, aggregatorGandalf.aggregatorConfiguration.AggregatorCommandReceiveFromConnectorConnection, aggregatorGandalf.aggregatorConfiguration.AggregatorCommandSendToConnectorConnection, aggregatorGandalf.aggregatorConfiguration.AggregatorCommandSendToClusterConnections, aggregatorGandalf.aggregatorConfiguration.AggregatorCommandReceiveFromClusterConnections)
	aggregatorGandalf.aggregatorEventRoutine = NewAggregatorEventRoutine(aggregatorGandalf.aggregatorConfiguration.Identity, aggregatorGandalf.aggregatorConfiguration.Tenant, aggregatorGandalf.aggregatorConfiguration.AggregatorEventReceiveFromConnectorConnection, aggregatorGandalf.aggregatorConfiguration.AggregatorEventSendToConnectorConnection, aggregatorGandalf.aggregatorConfiguration.AggregatorEventSendToClusterConnections, aggregatorGandalf.aggregatorConfiguration.AggregatorEventReceiveFromClusterConnections)
